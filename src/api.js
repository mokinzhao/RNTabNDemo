...
export default {
    ...
    post_Login: 'https://api.yunchehome.com/test/login',

    menuInfo: [
            { title: '油卡充值', icon: require('./res/img/Home/icon_homepage_movieCategory.png') },
            { title: '违章查询', icon: require('./res/img/Home/icon_homepage_movieCategory.png') },
            { title: '导航', icon: require('./res/img/Home/icon_homepage_movieCategory.png') },
            { title: '路线', icon: require('./res/img/Home/icon_homepage_movieCategory.png') },
            { title: '买车', icon: require('./res/img/Home/icon_homepage_movieCategory.png') },
            { title: '报税', icon: require('./res/img/Home/icon_homepage_foottreatCategory.png') },
            { title: '开发票', icon: require('./res/img/Home/icon_homepage_movieCategory.png') },
            { title: '休闲', icon: require('./res/img/Home/icon_homepage_entertainmentCategory.png') },
        ],
        gridInfo: [
            { maintitle: '油卡充值', typeface_color: '#f6687d',deputytitle:'多开多送',imageurl:'http://p1.meituan.net/w.h/feop/c6681b171526be49dc7b042908c4c98227609.png'},
            { maintitle: '违章查询', typeface_color: '#f6687d',deputytitle:'多开多送1',imageurl:'http://p1.meituan.net/w.h/feop/c6681b171526be49dc7b042908c4c98227609.png' },
            { maintitle: '导航', typeface_color:'#f6687d',deputytitle:'多开多送2',imageurl:'http://p1.meituan.net/w.h/feop/c6681b171526be49dc7b042908c4c98227609.png'},
            { maintitle: '路线', typeface_color: '#f6687d',deputytitle:'多开多送3',imageurl:'http://p1.meituan.net/w.h/feop/c6681b171526be49dc7b042908c4c98227609.png' },
        ]
