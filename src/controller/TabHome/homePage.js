...
class HomeScene extends Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        headerTitle: (
            <TouchableOpacity style={styles.searchBar}>
                <Image source={require('../../res/img//Home/search_icon.png')} style={styles.searchIcon} />
    ...
    renderHeader() {
        return (
            <View>
                ...
                <HomeGridView infos={api.gridInfo} onGridSelected={(this.onGridSelected)} />
    ...
    render() {
      if(this.state.swiperShow){ 
        ...
        <Swiper loadMinimal={false} loadMinimalSize={1} style={styles.wrapper} autoplay>
          {
